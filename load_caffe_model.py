...
def main():
    ...
    parser.add_argument('--caffe_model_path', default='model/realismCNN_all_iter3.caffemodel', help='Path for caffe model')
    parser.add_argument('--chainer_model_path', default='model/realismCNN_all_iter3.npz', help='Path for saving chainer model')
